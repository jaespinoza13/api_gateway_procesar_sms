pipeline {
    ...
    environment {
        ...
        NOMBRE_CONTENEDOR   = 'apigateway-callcenter-e2'
        NOMBRE_IMAGEN       = 'apigateway_callcenter_e2'
        PUERTO              = '6002'
        PUERTO_CONTENEDOR   = '80'
        RUTA_CONFIG 		= '/config/ApiGatewayCallCenter/'
        RUTA_LOGS = '/app/ApiGatewayCallCenter'
    }
